...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentMethod: Attribute.Enumeration<['cod', 'bkash', 'nagod']>;
    status: Attribute.Enumeration<['placed', 'shipped', 'delivered']>;
    products: Attribute.Relation<
      'api::order.order',
      'oneToMany',
      'api::product.product'
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media;
    status: Attribute.Enumeration<['in stock', 'stock out']>;
...
export interface ApiSizeSize extends Schema.CollectionType {
  ...
  attributes: {
    size: Attribute.Enumeration<['small', 'medium', 'large', 'extra large']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
