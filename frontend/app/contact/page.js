  ...
  return (
    <section className="text-gray-600 body-font relative">
      <div className=" pt-8 pb-3 md:pt-10 md:pb-5 text-center text-black">
        <h1 className="text-3xl text-bold mt-5 mb-10">Contact Us</h1>
      </div>
      <div className="container px-5 pt-10 pb-24 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="mt-1">Secrateriet lane, Rally, Bandar, Narayanganj</p>
            </div>
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          ...
          <p className="leading-relaxed mb-5 text-gray-600">Provide your feedback about our product. How can it be improved to serve you better experience</p>
          ...
          <button className="text-white bg-black py-2 px-6 hover:bg-white hover:text-black border hover:border-gray-800 rounded text-lg">Send Message</button>
